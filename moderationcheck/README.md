# moderationcheck serverless API
The moderationcheck project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=moderationcheck -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-jersey-archetype -DarchetypeVersion=1.3.2 -DgroupId=de.facecheck -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd moderationcheck
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "ModerationcheckApi",
                    "OutputKey": "ModerationcheckApi",
